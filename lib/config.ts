export const config = {
    ...
    groomFather: process.env.NEXT_PUBLIC_GROOM_FATHER || "",
    groomMother: process.env.NEXT_PUBLIC_GROOM_MOTHER || "",
    ...
    brideFather: process.env.NEXT_PUBLIC_BRIDE_FATHER || "",
    brideMother: process.env.NEXT_PUBLIC_BRIDE_MOTHER || "",
    ...
    holyMatrimony: {
        ...
        date: process.env.NEXT_PUBLIC_HOLY_MATRIMONY_DATE || process.env.NEXT_PUBLIC_EVENT_DATE || "2025-01-01T00:00:00",
        time: process.env.NEXT_PUBLIC_HOLY_MATRIMONY_TIME || "00:00",
        lunarDate: process.env.NEXT_PUBLIC_HOLY_MATRIMONY_LUNAR || "",
    ...
    weddingReception: {
        ...
        lunarDate: process.env.NEXT_PUBLIC_WEDDING_RECEPTION_LUNAR || "",
